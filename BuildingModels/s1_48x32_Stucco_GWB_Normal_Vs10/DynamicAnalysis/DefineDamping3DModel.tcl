...
set periodForRayleighDamping_1 0.187; 
set periodForRayleighDamping_2 0.154; 
...
region 1 -eleRange	700000	700020	-rayleigh	0	$alpha2	0	0; 
# Assign damping to nodes 
region 2 -node	2000	2100	2200	2300	2400	2500	2600	2700	2800	-rayleigh	$alpha1	0	0	0; 
