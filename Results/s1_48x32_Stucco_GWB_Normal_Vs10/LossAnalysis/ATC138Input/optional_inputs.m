...
repair_time_options.allow_tmp_repairs = true; 
repair_time_options.allow_shoring = true; 

% Functionality and Habitability Assessment Options 
...
functionality_options.include_local_stability_impact = true; 
functionality_options.include_flooding_impact = true; 
functionality_options.egress_threshold = 0.5; 
functionality_options.fire_watch = true; 
functionality_options.local_fire_damage_threshold = 0.25; 
...
functionality_options.water_pressure_max_story = 1; 
functionality_options.habitability_requirements.electrical = false; 
functionality_options.habitability_requirements.water_potable = false; 
functionality_options.habitability_requirements.water_sanitary = false; 
functionality_options.habitability_requirements.hvac_ventilation = false; 
functionality_options.habitability_requirements.hvac_heating = false; 
functionality_options.habitability_requirements.hvac_cooling = false; 
functionality_options.habitability_requirements.hvac_exhaust = false; 
